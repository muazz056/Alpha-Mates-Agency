        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="focus-outline inline-flex items-center gap-2 rounded-xl border border-zinc-300 bg-white/60 px-7 py-3.5 text-sm font-semibold backdrop-blur-sm transition hover:border-brand-200 hover:bg-white hover:shadow-lg dark:border-white/10 dark:bg-zinc-900/60 dark:hover:border-brand-800 dark:hover:bg-zinc-900"
            >
